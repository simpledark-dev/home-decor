...
export const projects: Project[] = [
  {
    ...
    description: [
      "Căn hộ Vinhomes Central Park là dự án thiết kế nội thất cho một gia đình trẻ với hai con nhỏ. Với diện tích 95m², đội ngũ Luxury House đã tập trung vào việc tối ưu hóa từng góc không gian, đảm bảo vừa đẹp mắt vừa thực dụng cho cuộc sống hàng ngày.",
  ...
  },
  {
    ...
    shortDesc:
      "Nhà phố 3 tầng tại Thảo Điền với phong cách đương đại ấm áp, hài hòa giữa thẩm mỹ và công năng.",
    description: [
      "Nhà phố tại Thảo Điền là dự án cải tạo toàn bộ nội thất cho một ngôi nhà 3 tầng. Gia chủ là một cặp vợ chồng trung niên mong muốn có không gian sống thoải mái, gần gũi thiên nhiên nhưng vẫn hiện đại và tiện nghi.",
  ...
  },
  {
    ...
    description: [
      "Căn hộ Masteri Thảo Điền là thử thách thú vị cho đội ngũ Luxury House — làm sao để 75m² trở nên rộng rãi, thoáng đãng mà vẫn đầy đủ tiện nghi cho một bạn trẻ độc thân. Phong cách Scandinavian được lựa chọn vì sự tối giản, sáng sủa và ấm áp đặc trưng.",
  ...
  },
  {
    ...
    shortDesc:
      "Nhà phố 4 tầng với phong cách hiện đại kết hợp chất liệu truyền thống Việt Nam, dành cho gia đình ba thế hệ.",
    description: [
      "Nhà phố Gò Vấp là dự án thiết kế cho một gia đình ba thế hệ — ông bà, bố mẹ và hai con nhỏ. Thách thức lớn nhất là làm sao để mỗi thành viên đều có không gian riêng tư nhưng vẫn duy trì sự gắn kết gia đình. Luxury House đã đề xuất phong cách hiện đại Việt Nam, vừa quen thuộc với thế hệ lớn tuổi vừa hợp gu giới trẻ.",
  ...
  },
  {
    ...
    description: [
      "Căn hộ The Manor là dự án dành cho một gia đình yêu thích phong cách cổ điển châu Âu. Với diện tích 120m², Luxury House đã tạo nên một không gian sống sang trọng nhưng không quá nặng nề, phù hợp với khí hậu và lối sống tại Sài Gòn.",
  ...
  },
  {
    ...
    category: "Nhà Phố",
    location: "Phú Mỹ Hưng, TP.HCM",
    area: "180m²",
    style: "Tối giản sang trọng",
    shortDesc:
      "Nhà phố 3 tầng tại Phú Mỹ Hưng với phong cách tối giản sang trọng, tập trung vào chất liệu cao cấp và đường nét tinh gọn.",
    description: [
      "Nhà phố Quận 7 tọa lạc trong khu đô thị Phú Mỹ Hưng, là dự án thiết kế cho một cặp vợ chồng trẻ thành đạt. Gia chủ yêu thích sự tối giản nhưng vẫn muốn không gian sống thể hiện được gu thẩm mỹ và chất lượng cuộc sống. Luxury House đã đề xuất phong cách minimal luxury — ít chi tiết nhưng mỗi chi tiết đều tinh tế.",
